...
public class OtpAppDaoImpl implements OtpAppDAO{
	...
	public String sendResetCode(String username) throws ClassNotFoundException, SQLException {
	    connection = ConnectionHelper.getConnection();
	    String cmd = "SELECT Cust_ID, Customer_Email FROM customer WHERE Customer_UserName=?";
	    PreparedStatement pst = connection.prepareStatement(cmd);
	    pst.setString(1, username);
	    ResultSet rs = pst.executeQuery();
	    ...
	    if (rs.next()) {
	        ...
	        MailSend.mailOtp(email, subject, body);
	...
	private String generateResetCode() {
	    // Generate a random alphanumeric code of 10 characters
	    String characters = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
	    StringBuilder resetCode = new StringBuilder(10);
