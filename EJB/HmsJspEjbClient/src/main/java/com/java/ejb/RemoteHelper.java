...
// we are doing jndi properties we are doing here
	...
	private static Context createInitialContext() throws NamingException {
	   ...
	   public static PatientReportRemote lookupRemoteStatelessPatient() throws NamingException {
	   ...
	   //     System.out.println(RemoteCalculator.class.getName());
	        final String viewClassName = PatientReportRemote.class.getName();
	        // let's do the lookup
